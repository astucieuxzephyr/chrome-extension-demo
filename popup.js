...
function showAnswer(e) {
  ...
  if ((answer == cardData.answer) || 
    ...
    var color = '#00c62a';
    var text_eng = 'Yay, you got it!'; //TODO randomize
	var text = 'Bravo, c\'est la bonne réponse !';
  } else {
    ...
    var color = 'red';
    var text_eng = 'Better luck next time!';
	var text_fr = 'Rat&eacute;, bonne chance &agrave; vous la prochaine fois !';
	var text = text_fr;
  }
  ...
  if (cardData.answerlong) {
    ...
    getById('back-answerlong').innerHTML = 'La réponse correcte est : <b>' + cardData.answer + '</b>';
...
function showStats() {
  ...
  getById('stats-leitnerlink').onclick = function() {
    openLink('https://fr.wikipedia.org/wiki/Syst%C3%A8me_Leitner');
